      ...
      <div className="max-w-[1900px] mx-auto my-4 px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 select-none">
        ...
        <div className="bg-[#c5e0db] rounded-xl p-2 shadow-lg flex flex-col items-center mb-2">
          <div className="w-full flex relative gap-35 pb-2">
                  ...
                  <div className="space-y-0">
                    ...
                    <div className="flex items-end gap-13">
                      <div className="transition-all duration-300 group-hover:scale-115">
                        <p className="text-white text-6xl font-bold">{lastHourRecordings.line01.length}</p>
                    ...
                    <div className="py-0 my-0">
                      <p className="text-[#F4A73C] ml-2 text-3xl font-bold mb-0">{lineRecordings.line01.length}</p>
            ...
            <div className="absolute left-1/2 -translate-x-1/2 top-8 w-20 h-20 rounded-full flex flex-col items-center justify-center shadow-[0_5px_10px_rgba(0,0,0,0.5)] z-10 transition-all duration-300 hover:scale-120 hover:shadow-[0_5px_10px_rgba(0,0,0,0.5)] bg-gradient-to-br from-[#F4A73C] to-[#F97316] hover:from-[#0F676A] hover:to-[#083D3F]">
              <p className="text-white text-5xl font-bold">1</p>
            </div>
            ...
            <div className="flex-1 mt-1 pl-3 pr-1 pt-2 pb-1 bg-gradient-to-br from-[#0F676A] to-[#083D3F] rounded-xl shadow-[0_10px_20px_rgba(0,0,0,0.5)] transition-all duration-400 hover:-translate-y-2 hover:-rotate-1 hover:brightness-110 relative overflow-hidden group">
              ...
              <div className="flex justify-between items-start">
                <div className="space-y-0">
                  {/* Last Hour - with inline icon placement */}
                  <div className="flex items-end justify-between">
                    <div className="transition-all duration-300 group-hover:scale-115">
                      <div className="flex items-end gap-1">
                        <p className="text-white text-5xl font-bold">
                          {totalHourDurations.line01.split('M')[0] + 'M'}
                        </p>
                        <p className="text-white text-3xl font-bold pb-1.5">
                          {totalHourDurations.line01.split('M')[1]}
                        </p>
                      </div>
                      <p className="text-[#CBD5E1] text-sm mt-0 font-semibold">Last Hour</p>
                    </div>

                    {/* Stopwatch Icon positioned next to Last Hour */}
                  ...
                  <div className="pt-0">
                    <div className="flex items-end gap-1 mt-1">
                      <p className="text-[#F4A73C] text-3xl font-bold">
                          {totalDurations.line01.split('M')[0] + 'M'}
                        </p>
                        <p className="text-[#F4A73C] text-2xl font-bold pb-1">
                          {totalDurations.line01.split('M')[1]}
                        </p>
                    </div>
        ...
        <div className="bg-[#c5e0db] rounded-xl p-2 shadow-lg flex flex-col items-center mb-2">
          <div className="w-full flex relative gap-35 pb-2">
              ...
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <div className="space-y-0">
                    ...
                    <div className="flex items-end gap-13">
                      <div className="transition-all duration-300 group-hover:scale-115">
                        <p className="text-white text-6xl font-bold">{lastHourRecordings.line03.length}</p>
                        <p className="text-[#CBD5E1] font-semibold text-sm mt-0">Last Hour</p>
                      </div>
                      {/* Telephone Icon positioned next to Last Hour */}
                      <div className="mb-4 transition-all duration-300 group-hover:scale-115">
                    ...
                    <div className="pt-0 mt-0">
                      <p className="text-[#F4A73C] ml-2 text-3xl font-bold">{lineRecordings.line03.length}</p>
                      <p className="text-[#CBD5E1] font-semibold text-sm mt-0 pt-0">Today</p>
                    </div>
                  </div>
                </div>
            ...
            {/* Line Number Bubble */}
            <div className="absolute left-1/2 -translate-x-1/2 top-8 w-20 h-20 rounded-full flex flex-col items-center justify-center shadow-[0_5px_10px_rgba(0,0,0,0.5)] z-10 transition-all duration-300 hover:scale-120 hover:shadow-[0_5px_10px_rgba(0,0,0,0.5)] bg-gradient-to-br from-[#F4A73C] to-[#F97316] hover:from-[#0F676A] hover:to-[#083D3F]">
              <p className="text-white text-5xl font-bold">2</p>
            </div>
                ...
                <div className="space-y-0">
                  ...
                  <div className="flex items-end justify-between">
                    <div className="transition-all duration-300 group-hover:scale-115">
                      <div className="flex items-end gap-1">
                        <p className="text-white text-5xl font-bold">
                          {totalHourDurations.line03.split('M')[0] + 'M'}
                        </p>
                        <p className="text-white text-3xl font-bold pb-1.5">
                          {totalHourDurations.line03.split('M')[1]}
                        </p>
                      </div>
                      <p className="text-[#CBD5E1] text-sm mt-0 font-semibold">Last Hour</p>
                    </div>
                  ...
                  <div className="pt-0">
                    <div className="flex items-end gap-1">
                      <p className="text-[#F4A73C] text-3xl font-bold">
                          {totalDurations.line03.split('M')[0] + 'M'}
                        </p>
                        <p className="text-[#F4A73C] text-2xl font-bold pb-1">
                          {totalDurations.line03.split('M')[1]}
                        </p>
                    </div>
                    <p className="text-[#CBD5E1] text-sm mt-0 pt-0 font-semibold">Today</p>
                  </div>
          ...
          <div className="w-full flex relative gap-35 pb-2">
              ...
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <div className="space-y-0">
                    ...
                    <div className="flex items-end gap-13">
                      <div className="transition-all duration-300 group-hover:scale-115">
                        <p className="text-white text-6xl font-bold">{lastHourRecordings.line05.length}</p>
                        <p className="text-[#CBD5E1] font-semibold text-sm mt-0">Last Hour</p>
                      </div>
                      {/* Telephone Icon positioned next to Last Hour */}
                      <div className="mb-4 transition-all duration-300 group-hover:scale-115">
                    ...
                    {/* Today */}
                    <div className="pt-0 mt-0">
                      <p className="text-[#F4A73C] ml-2 text-3xl font-bold">{lineRecordings.line05.length}</p>
                      <p className="text-[#CBD5E1] font-semibold text-sm mt-0 pt-0">Today</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="flex-1 mt-1 pl-3 pr-1 pt-2 pb-1 bg-gradient-to-br from-[#0F676A] to-[#083D3F] rounded-xl shadow-[0_10px_20px_rgba(0,0,0,0.5)] transition-all duration-400 hover:-translate-y-2 hover:-rotate-1 hover:brightness-110 relative overflow-hidden group">
              ...
              <div className="flex justify-between items-start">
                <div className="space-y-0">
                  {/* Last Hour - with inline icon placement */}
                  <div className="flex items-end jutify-between">
                    <div className="transition-all duration-300 group-hover:scale-115">
                      <div className="flex items-end gap-1">
                        <p className="text-white text-5xl font-bold">
                          {totalHourDurations.line05.split('M')[0] + 'M'}
                        </p>
                        <p className="text-white text-3xl font-bold pb-1.5">
                          {totalHourDurations.line05.split('M')[1]}
                        </p>
                      </div>
                      <p className="text-[#CBD5E1] text-sm mt-0 font-semibold">Last Hour</p>
                    </div>
                  ...
                  <div className="pt-0">
                    <div className="flex items-end gap-1">
                      <p className="text-[#F4A73C] text-3xl font-bold">
                          {totalDurations.line05.split('M')[0] + 'M'}
                        </p>
                        <p className="text-[#F4A73C] text-2xl font-bold pb-1">
                          {totalDurations.line05.split('M')[1]}
                        </p>
                    </div>
                    <p className="text-[#CBD5E1] text-sm mt-0 pt-0 font-semibold">Today</p>
                  </div>
